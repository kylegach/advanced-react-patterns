...
- Using context to allow non-immediate children to receive implicit state
- Reporting a more useful error when context-dependent component is used outside
  of provider
- Giving context provider a more useful name in React Dev Tools
