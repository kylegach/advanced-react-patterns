...
- How to implement a prop collection pattern
- How to implement a prop getter pattern and why that's important for a flexible
  API
  - Composition of provided props and consumer props, e.g. onClick
- callAll helper function
